...
<form
	...
	class="{INPUT_CLASSES} border-radius-bottom-none mx-auto max-w-[48rem] overflow-hidden rounded-3xl backdrop-blur-md {isBranchMode
		? 'branch-mode'
		: ''} {className}"
>
...
<style>
	...
	@keyframes goldPulse {
		...
		50% {
			box-shadow: 0 0 20px 5px rgba(234, 179, 8, 0.6);
		}
	}
</style>
